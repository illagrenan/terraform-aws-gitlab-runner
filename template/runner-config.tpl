...
[[runners]]
  ...
  [runners.machine]
    ...
    MachineOptions = [
        ...
        "amazonec2-tags=environment,${environment},runner-manager-name,gitlab-aws-autoscaler,gitlab,true,gitlab-runner-autoscale,true",
        "amazonec2-monitoring=${runners_monitoring}",
        "amazonec2-root-size=${runners_root_size}",
        "amazonec2-iam-instance-profile=${runners_iam_instance_profile_name}"${runners_registry_mirror}
    ]
